...
impl TokenManager {
    pub fn new(client_id: String, client_secret: String, redirect_uri: String, auth_code: String) -> Self {
        Self {
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let token_manager = TokenManager::new("client_id".to_string(), "client_secret".to_string(), "redirect_uri".to_string(), "auth_code".to_string());
